...
function sale(){
    var price = 197500;
    showPrice.innerHTML ="Total:" + myInput.value*price+"EGP";
}
function sale2(){
    var price = 324900;
    showPrice2.innerHTML ="Total:" + myInput2.value*price+"EGP";
}
function sale3(){
    var price = 559600;
    showPrice3.innerHTML ="Total:" + myInput3.value*price+"EGP";
}
function sale4(){
    var price = 460000;
    showPrice4.innerHTML ="Total:" + myInput4.value*price+"EGP";
}
function sale5(){
    var price = 295000;
    showPrice5.innerHTML ="Total:" + myInput5.value*price+"EGP";
}
function sale6(){
    var price = 305000;
    showPrice6.innerHTML ="Total:" + myInput6.value*price+"EGP";
}
function sale7(){
    var price = 399900;
    showPrice7.innerHTML ="Total:" + myInput7.value*price+"EGP";
}
function sale8(){
    var price = 309900;
    showPrice8.innerHTML ="Total:" + myInput8.value*price+"EGP";
}
...
function ok4(){
            ...
            Complete4.style.animation="change 2s 2 ease";
}
function ok5(){
